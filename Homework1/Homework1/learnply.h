...
Corner **clist;      /* list of corners */
  ...
  Triangle *other_triangle(Edge *, Triangle *);
	...
	void calculate_bounding_box_with_moments();
	void calculate_bounding_box_with_normals();
	void CreateCornerList();

	Polyhedron();
  Polyhedron(FILE *);
  Polyhedron(FILE *, int Regular);
  Polyhedron(FILE *, float IRegular);
